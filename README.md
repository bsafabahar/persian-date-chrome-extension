# 🗓️ تبدیل تاریخ میلادی به شمسی (نسخه 1.2.0)
...
### نسخه 1.2.0
- 🔧 بهبودهای قابل توجه در الگوریتم تبدیل تاریخ
- 🌐 بهبود مدیریت دامنه‌ها و عملکرد بهتر
- 🧹 حذف فایل‌های غیرضروری و بهینه‌سازی کد
- 📋 تغییرات در ساختار پروژه
- 📚 به‌روزرسانی مستندات و بهبود کیفیت کد

### نسخه 1.1.0
- 🎛️ بهبود مدیریت وضعیت افزونه
- ✅ اضافه کردن چک‌لیست برای فعال‌سازی/غیرفعال‌سازی
- ⚡ بهینه‌سازی الگوریتم تبدیل تاریخ
- 🔧 اضافه کردن قابلیت‌های جدید برای مدیریت بهتر
- 📈 بهبود عملکرد و پایداری افزونه
